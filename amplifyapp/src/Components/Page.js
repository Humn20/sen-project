            ...
            <Row>
              <div className="d-grid gap-2">
                <Button
                  ...
                  className={`fw-bold text-center ${global ? "" : "fw-bold"}`}
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="19"
                    ...
                    fill="currentColor"
                    viewBox="0 0 16 16"
                    className=" bi bi-laptop d-inline-block align-center"
                  >
                  ...
                  <div>
                    <span>
                      <svg
                        ...
                        fill="currentColor"
                        viewBox="0 0 16 16"
                        className=" bi bi-globe-americas d-inline-block align-center"
                      >
